      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h2 className="text-base font-semibold text-gray-900 mb-1">Applications</h2>
            <p className="text-sm text-gray-500">Payment verification queue.</p>
          </Link>

          <Link
            href="/head-master/export"
            className="group bg-white rounded-xl border border-gray-100 p-6 hover:border-red-200 hover:shadow-sm transition-all"
          >
            <div className="inline-flex items-center justify-center w-10 h-10 bg-red-50 rounded-lg mb-4 group-hover:bg-red-100 transition-colors">
              <svg className="w-5 h-5 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h2 className="text-base font-semibold text-gray-900 mb-1">Excel Export</h2>
            <p className="text-sm text-gray-500">Download approved participant lists.</p>
          </Link>
        </div>
      </main>
    </div>
